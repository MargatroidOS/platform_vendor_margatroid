#
# MargatroidOS Audio Files
#

ALARM_PATH := vendor/margatroid/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/margatroid/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/margatroid/prebuilt/common/media/audio/ringtones
